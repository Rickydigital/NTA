...
<div class="page-header">
    <div>
        <h4 class="page-title">{{ __('messages.edit_user') }}</h4>
...
<form method="POST" action="{{ route('users.update', $user->user_id) }}">
                ...
                <select name="sector_id" id="sector_id"
                    ...
                    @foreach ($sectors as $sector)
                        <option value="{{ $sector->sector_id }}"
                            {{ old('sector_id', $user->sector_id) == $sector->sector_id ? 'selected' : '' }}>
                            {{ $sector->name }}
                        </option>
                    @endforeach
                </select>
                ...
                <select name="institution_id" id="institution_id"
                    ...
                    @foreach ($institutions as $institution)
                        <option value="{{ $institution->institution_id }}"
                                ...
                                {{ old('institution_id', $user->institution_id) == $institution->institution_id ? 'selected' : '' }}>
                            {{ $institution->name }}
    ...
    <div class="form-actions">
        ...
        <button type="submit" class="btn btn-primary btn-sm">
            <i class="mdi mdi-check mr-1"></i>{{ __('messages.update_user') }}
        </button>
    </div>
</form>
